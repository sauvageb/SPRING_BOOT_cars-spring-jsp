...
<html lang="en">
<head>
    <title>CarEE | Add Category</title>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <form id="form" method="post" action="${pageContext.request.contextPath}/auth/add-category"
                          class="text-center">
                        ...
                        <input type="submit" class="btn btn-lg btn-color btn-button" value="Add Category">
